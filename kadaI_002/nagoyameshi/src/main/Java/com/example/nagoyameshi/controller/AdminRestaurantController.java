...
public class AdminRestaurantController {
    ...
    public String edit(@PathVariable(name = "id") Integer id, Model model) {
        ...
        RestaurantEditForm restaurantEditForm = new RestaurantEditForm(restaurant.getId(), restaurant.getName(), null, restaurant.getDescription(), restaurant.getPrice(), restaurant.getPostalCode(), restaurant.getAddress(), restaurant.getPhoneNumber(), restaurant.getBusinessHours(), restaurant.getRegularHoliday(), restaurant.getSeats(), restaurant.getCategory());
